...
/** The candidate-carrier corroboration monoid, proven law-first. `corroborate ⊕ₖ` is the spine of
  * the fold — the order in which evidence is folded must not change the verdict — so its
