...
4. **[`claim-calculus.html`](https://reggieperry.github.io/claim-algebra-experiment/docs/claim-algebra/claim-calculus.html)** — the operational meta-theory: a small reduction system over evidence-event sequences, with proved meta-theorems (determinacy, finite-fold termination, assertion permutation invariance, withdrawal idempotence, non-fabrication, exclusivity, fail-closed propagation, and more) and deliberate non-theorems (full-language permutation invariance, absolute soundness). The semantics behind the Ledger fold and the signing gate.
