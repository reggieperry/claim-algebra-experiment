...
3. **W reproduces the null.** W must sign ≈ 0 (within its now-powered interval); if W signs materially, the p/error-model wiring drifted and every contrast is read with that caveat.
